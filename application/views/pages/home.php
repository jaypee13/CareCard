...
<div class="row align-items-top justify-content-center">
    ...
    <div class="panel-transparent border left" style="min-width: 300px; width: 600px; max-width: 100%; padding: 4px; margin:0.2;">
      <span class="text2" style="margin: 0px 0px 4px;"><b>TAYTAY CARE CARD - </b> Proyektong ibinahagi sa mga mamamayan ng Taytay Rizal mula sa SANGUNIANG BAYAN at Mayor Omil Poblete.</span>
      
      <div>
        <span class="text3" style="margin: 0px 0px 10px; padding: 6px;">INTERESADO KABA MAKAKUHA NG TAYTAY CARE CARD? <a style="font-size:14px;" href="<?php base_url(); ?>FAQs">(PARAAN NG PAGKUHA NG CARD)</a></span>
      </div>
