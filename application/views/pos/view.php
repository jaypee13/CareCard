	...
	<?php
	   ...
	   // echo "<br/>";
	   if ($UserLevel !== 99){
	   		echo "<a href='". base_url() . "pos/reload' class='captionBG'>Return To List</a>"; }
	?>
...
<div class="row center-div2">
	<div class="col-xs-6 col-sm-3 gradiant-bg border border-white" style="padding: 5px; margin:0.2; border:1px;  min-width: 300px; max-width: 390px; word-wrap: break-word;">
		<h5 class="card-body" style="height:30px; margin:0px; padding:0px; text-align: center;">Profile</h5>
        ...
        <div class="card border-light mb-3" >
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item"><b>HEIGHT:</b> <?php echo $QueryOutput['intHeight'] . ' cms &nbsp;&nbsp;<b>WEIGHT:</b> ' . number_format($QueryOutput['dblWeight']) . ' kls'; ?></li>
				...
				*** Signature ***</li>
				...
				<li class="list-group-item" style="margin:0.1; padding:1px;background-color:white;text-align: center; vertical-align: middle; display: flex; justify-content: center;">
					...
					<?php 
						...
						if ($intCount == 0){
					    	echo "<td style='padding: 0; margin:0.1; border: 1px solid lightgray'>NO RECORD FOUND.</td>";
					    }
